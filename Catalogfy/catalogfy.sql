...
--
-- Host: 127.0.0.1
-- Tempo de geração: 13/04/2024 às 03:03
...
CREATE TABLE `produtos` (
  `id` int(11) NOT NULL,
  `foto` varchar(300) NOT NULL DEFAULT 'semfoto.jpg',
  `nome` varchar(100) NOT NULL,
...
ALTER TABLE `produtos`
  ...
  ADD CONSTRAINT `produtos_ibfk_2` FOREIGN KEY (`id_usuario_resp`) REFERENCES `usuarios` (`id`);
COMMIT;
