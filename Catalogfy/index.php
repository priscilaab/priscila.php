...
<body>
    <nav class="navbar navbar-expand-sm navbar-dark" style="background-color: #227b;">
    ...
    <div class="container">
        ...
        <div class="card-deck row mt-5">
            <?php foreach ($tabela as $produto) { ?>
                <div class="col-3">
                    <div class="card text-center h-100" style="width: 10rem;">
                        <a href="produto.php?id=<?=$produto['id'];?>"><img class="card-img-top" src="admin/fotos/<?=$produto['foto']; ?>" alt="<?= $produto['nome']; ?>"></a>
                        <div class="card-body">
                            <h4 class="card-title"><?=$produto['nome']; ?></h4>
                            <p class="card-text"><?=$produto['descricao']; ?>
                            <div class="d-grid gap-2 card-footer">
                                <a href="produto.php?id=<?=$produto['id'];?>" class="btn btn-dark">Mais detalhes...</a>
                            </div>
                            </p>
                        </div>
                    </div>
